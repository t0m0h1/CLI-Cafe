...
choice = int(input("""please pick a drink :) .....
    """))
...
Unfortunately this item doesn't exist""")
...
# if you don't want the traceback to mess up the visuals then delete this function and the call below.
